...
export class examEditUpdateComponent implements OnInit {
  ...
  createForm() {
    this.editExamForm = this.fb.group({
      ...
      passingMarks: [
        null,
        [Validators.required, Validators.pattern(appConfig.pattern.IVR_NUMBER)]
      ],
  ...
  fn_setEditValues() {
    ...
    this.editExamForm.controls.description.setValue(
      this.examDetail.description
    );
    this.editExamForm.controls.examDurationHours.setValue(
      this.examDetail.examDurationHours
    );
    this.editExamForm.controls.examDurationMinutes.setValue(
      this.examDetail.examDurationMinutes
    );
    this.editExamForm.controls.passingMarks.setValue(
    ...
    this.editExamForm.controls.shuffleQuestions.setValue(
      this.examDetail.shuffleQuestions
    );
    this.editExamForm.controls.shuffleOptions.setValue(
      this.examDetail.shuffleOptions
    );
